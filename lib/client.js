...
* @param {{id: String, limit: Number, filter: String, offset: Number}}
*/
TidalAPI.prototype.getUserPlaylists = function (user, callback){
  var self = this;
  self._baseRequest('/users/' + user + '/playlists', {
      limit: 9999,
      countryCode: _countryCode
  }, '', callback);
}
...
* @param {{id: String, limit: Number, filter: String, offset: Number}}
*/
TidalAPI.prototype.addPlaylistTracks = function (playlist, tracks, etag, callback){
  var self = this;
  self._basePost('/playlists/' + playlist + '/items', {
      countryCode: _countryCode
  }, {trackIds: tracks, toIndex: 0}, 'playlists', etag, callback);
}
...
* @param {{id: String, limit: Number, filter: String, offset: Number}}
*/
TidalAPI.prototype.deletePlaylistTracks = function (playlist, tracks, etag, callback){
  var self = this;
  self._baseDelete('/playlists/' + playlist + '/items/'+tracks, {
      countryCode: _countryCode,
      orderDirection: 'ASC',
      order: 'INDEX'
  }, {/*trackIds: tracks, toIndex: 1*/}, '', etag, callback);
}
...
* @param {{method: String, params: Object, type: String, callback: Function}}
*/
TidalAPI.prototype._baseDelete = function(method, params, formdata, type, etag, callback) {
  var self = this;
...
* @param {{method: String, params: Object, type: String, callback: Function}}
*/
TidalAPI.prototype._basePost = function(method, params, formdata, type, etag, callback) {
  var self = this;
