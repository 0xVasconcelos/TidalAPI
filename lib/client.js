...
TidalAPI.prototype.getPlaylistTracks = function (query, callback){
  var self = this;
  self._baseRequest('/playlists/' + (query.uuid || query) + '/tracks', {
      limit: query.limit || 999,
      filter: query.filter || 'ALL',
      offset: query.offset || 0,
      countryCode: _countryCode
...
* @param {{uuid: String, trackIds: List<Number>, toIndex: Number}}
*/
TidalAPI.prototype.addPlaylistTracks = function (data, callback){
  var self = this;
  self._basePost('/playlists/' + data.uuid + '/items', {
      countryCode: _countryCode
  }, {trackIds: data.trackIds.join(','), toIndex: data.toIndex || 0}, 'playlists', callback);
}

/**
* Delete tracks from a playlist, based on their positions
* @param {{uuid: String, trackPositions: List<Number>, orderDirection: String, order: String}}
*/
TidalAPI.prototype.deletePlaylistTracks = function (data, callback){
  var self = this;
  self._baseDelete('/playlists/' + data.uuid + '/items/'+(data.trackPositions.join(',')), {
      countryCode: _countryCode,
      orderDirection: data.orderDirection || 'ASC',
      order: data.order || 'INDEX'
  }, {/*trackIds: tracks, toIndex: 1*/}, '', callback);
}
...
* @param {{method: String, params: Object, type: String, callback: Function}}
*/
TidalAPI.prototype._baseDelete = function(method, params, formdata, type, callback) {
  var self = this;
...
* @param {{method: String, params: Object, type: String, callback: Function}}
*/
TidalAPI.prototype._basePost = function(method, params, formdata, type, callback) {
  var self = this;
